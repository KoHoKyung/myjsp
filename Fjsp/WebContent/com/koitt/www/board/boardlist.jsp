...
<body class="w3-sand w3-container w3-margin-top" style="background: url('/img/avatar/1324.gif')">
	...
	<div class="w3-col m6 w3-center w3-white">
		...
		<form method="POST" action="/board/boardlist.cls">
			...
			<select class="w3-right" style="padding: 7px; margin-right: 5px;"
				name="select">
				<option value="1003" selected="selected">제목</option>
				<option value="1004">작성자</option>
				<option value="1005">내용</option>
				<option value="1006">제목+내용</option>
			</select>
		</form>
		<div class="w3-col w3-padding w3-margin-bottom ">
			<div class="w3-row w3-border w3-green">
				<!-- 글번호 | 작성자 | 작성일 | 타이틀 -->
				<div class="w3-col m2 w3-boarder-right w3-padding-16">글번호</div>
				<div class="w3-col m2 w3-boarder-right w3-padding-16 ">작성자</div>
				<div class="w3-col m2 w3-boarder-right w3-margin-left w3-padding-16">작성일</div>
				<div class="w3-col m5 w3-padding-16">제목</div>
			</div>

			<c:forEach var="data" items="${LIST}" varStatus="count">
				<div class="w3-row w3-border so " id="${data.fb_no}">
					<div class="w3-col w3-button w3-sand">
						<!-- 글번호 | 작성자 | 작성일 | 타이틀 -->
						<div class="w3-col m1 w3-boarder-right w3-margin-left">${data.fb_rn}</div>
						<div class="w3-col m3 w3-boarder-right">${data.fb_id}</div>
						<div class="w3-col m2 w3-boarder-right">${data.wdate}</div>
